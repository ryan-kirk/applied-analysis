...
This first Applied Analysis example shows how a familiar time series becomes more useful when the question is not just what the latest value is, but what changed and how that change should be interpreted.
...
- [Example folder](https://github.com/ryan-kirk/applied-analysis/tree/main/examples/trend_signal)
- [Insight document](https://github.com/ryan-kirk/applied-analysis/blob/main/examples/trend_signal/INSIGHT.md)
