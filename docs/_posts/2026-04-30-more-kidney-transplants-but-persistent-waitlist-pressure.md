...
This example adapts the basic comparison pattern to a public-interest healthcare systems question: what happens when a positive operational metric improves, but the broader system pressure remains high?
...
- [Example folder](https://github.com/ryan-kirk/applied-analysis/tree/main/examples/kidney_transplant_signal_comparison)
- [Insight document](https://github.com/ryan-kirk/applied-analysis/blob/main/examples/kidney_transplant_signal_comparison/INSIGHT.md)
