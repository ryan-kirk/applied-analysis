...
This page collects repository-level project profiles for the portfolio. Each profile is meant to answer a simple question: what does the application do, how is it structured, and why does it matter?
